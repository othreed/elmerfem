...
IF(NOT(BYPASS_DEB_DEPENDENCIES))
  ...
  ADD_DEBIAN_DEPENDENCY(WITH_ELMERGUI "libqt5-opengl")
  ADD_DEBIAN_DEPENDENCY(WITH_ELMERGUILOGGER "libqt5-core")
  ADD_DEBIAN_DEPENDENCY(WITH_ELMERGUITESTER "libqt5-core")
  ADD_DEBIAN_DEPENDENCY(WITH_OCC "liboce-foundation" "liboce-modeling8")
  ADD_DEBIAN_DEPENDENCY(WITH_PARAVIEW "paraview")
  ADD_DEBIAN_DEPENDENCY(WITH_VTK "libvtk5.8-qt5" "libvtk5.8")
